...
export class Init1749143602381 implements MigrationInterface {
    name = 'Init1749143602381'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "company" ("id_company" SERIAL NOT NULL, "ruc" character varying(20) NOT NULL, "legal_name" character varying(150) NOT NULL, "email" character varying(150) NOT NULL, "phone" character varying(20) NOT NULL, "logo" character varying(255), "second_user_sunat" character varying(100), "second_password_sunat" character varying(100), "db_name" character varying(100) NOT NULL, "is_delinquent" boolean NOT NULL DEFAULT false, "is_active" boolean NOT NULL DEFAULT true, "id_admin_user" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_bd3e40831fec9964ad5f464b202" UNIQUE ("legal_name"), CONSTRAINT "UQ_b0fc567cf51b1cf717a9e8046a1" UNIQUE ("email"), CONSTRAINT "PK_3cfb3efea34454bc843324000db" PRIMARY KEY ("id_company"))`);
        ...
        await queryRunner.query(`CREATE TABLE "admin_user" ("id_admin_user" SERIAL NOT NULL, "user_name" character varying(150) NOT NULL, "name" character varying(250) NOT NULL, "last_name" character varying(250) NOT NULL, "email" character varying(150) NOT NULL, "password" character varying(250) NOT NULL, "role" character varying NOT NULL DEFAULT 'admin', "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_489329ab9272a53443fc29f5908" UNIQUE ("user_name"), CONSTRAINT "UQ_840ac5cd67be99efa5cd989bf9f" UNIQUE ("email"), CONSTRAINT "PK_c0402c4c60ede47bd31b74f9d6d" PRIMARY KEY ("id_admin_user"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id_user" SERIAL NOT NULL, "id_branch" integer NOT NULL, "user_name" character varying(100) NOT NULL, "password" character varying(255) NOT NULL, "name" character varying(100) NOT NULL, "last_name" character varying(100) NOT NULL, "email" character varying(150) NOT NULL, "phone" character varying(20), "token" character varying(255), "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_d34106f8ec1ebaf66f4f8609dd6" UNIQUE ("user_name"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_9664961c0264d34a3cf82b11700" PRIMARY KEY ("id_user"))`);
        await queryRunner.query(`CREATE TABLE "branch" ("id_branch" SERIAL NOT NULL, "id_company" integer NOT NULL, "trade_name" character varying(100) NOT NULL, "address" character varying(255), "geo_code" character varying(10), "department" character varying(100), "province" character varying(100), "district" character varying(100), "urbanization" character varying(100), "annex_code" character varying(10), "phone" character varying(20), "email" character varying(150), "is_main" boolean NOT NULL DEFAULT false, "is_active" boolean NOT NULL DEFAULT true, "id_admin_user" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_9e5f273e5998742383cb70768d7" UNIQUE ("trade_name"), CONSTRAINT "PK_e33b0c461924981ec27fca8a872" PRIMARY KEY ("id_branch"))`);
